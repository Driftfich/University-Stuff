...
int main() {
    ...
    while (1==1) {
        ...
        switch (c) {
            case 'A' ... 'Z': {printf("Die Eingabe ist ein Großbuchstabe\n"); break;}
            case 'a' ... 'z' : {printf("Die Eingabe ist ein Kleinbuchstabe\n"); break;}
            case '0' ... '9' : {printf("Die Eingabe ist eine Zahl\n"); break;}
            default: printf("Die Eingabe ist ein Sonderzeichen\n");
        }
    }
    return 0;
}