...
template <> constexpr inline auto LibItemTableModel::qt_create_metaobjectdata<qt_meta_tag_ZN17LibItemTableModelE_t>()
{
    ...
    QtMocHelpers::UintData qt_enums {
        ...
        QtMocHelpers::EnumData<ColumnIdentity>(3, 3, QMC::EnumFlags{}).add({
            ...
            {   12, ColumnIdentity::MainArtist },
            {   13, ColumnIdentity::Publisher },
            {   14, ColumnIdentity::Description },
            {   15, ColumnIdentity::Genre },
            {   16, ColumnIdentity::Languages },
            {   17, ColumnIdentity::MaxColumnIdentity },
        }),
    };
